...
class Menu(models.Model):
    ...
    fk_Comida = models.ManyToManyField(Comida, null=False, blank=False, on_delete=models.CASCADE)
    fk_Bebidas= models.ManyToManyField(Bebidas, null=False, blank=False, on_delete=models.CASCADE)
    fk_Postres= models.ManyToManyField(Postres, null=False, blank=False, on_delete=models.CASCADE)
